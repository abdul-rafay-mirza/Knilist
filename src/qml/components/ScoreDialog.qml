...
Kirigami.Dialog {
    ...
    contentItem: ColumnLayout {
        ...
        Controls.SpinBox {
            ...
            onValueModified: scoreDialog.selectedScore = value
        }
                ...
                delegate: Kirigami.Icon {
                    ...
                    TapHandler {
                        onTapped: {
                            ...
                            scoreDialog.selectedScore = index + 1
                        }
                    }
                }
            }
            ...
            Repeater {
                ...
                delegate: Controls.Button {
                    ...
                    onClicked: {
                        ...
                        scoreDialog.selectedScore = modelData.value
                    }
                }
            }
        }
    ...
    onAccepted: {
        anilistService.saveScore(scoreDialog.anilistId, scoreDialog.selectedScore)
    }
}
