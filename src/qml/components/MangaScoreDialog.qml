...
Kirigami.Dialog {
    ...
    contentItem: ColumnLayout {
        ...
        Controls.SpinBox {
            ...
            from:  0
            to:    mangaScoreDialog.maxScore
            value: mangaScoreDialog.currentScore
            onValueModified: mangaScoreDialog.selectedScore = value
        }
            ...
            RowLayout {
                ...
                Controls.TextField {
                    ...
                    onTextChanged: {
                        ...
                        if (!isNaN(v) && v >= 0 && v <= 10)
                            mangaScoreDialog.selectedScore = v
                    }
                }
                ...
                delegate: Kirigami.Icon {
                    ...
                    TapHandler {
                        onTapped: {
                            ...
                            mangaScoreDialog.selectedScore = index + 1
                        }
                    }
                }
            }
            ...
            Repeater {
                ...
                delegate: Controls.Button {
                    ...
                    onClicked: {
                        ...
                        mangaScoreDialog.selectedScore = modelData.value
                    }
                }
            }
        }
    ...
    onAccepted: {
        anilistService.saveMangaScore(mangaScoreDialog.anilistId, mangaScoreDialog.selectedScore)
    }
}
